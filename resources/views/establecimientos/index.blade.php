...
@section('content')
    <div class="container">
        ...
        <div class="mt-5 row justify-content-center">
            <form class="col-md-9 col-xs-12 card card-body bg-ranita shadow" method="POST" action="{{ route('establecimiento.create') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <button type="submit" class="col btn btn-success m-1 font-weight-bolder shadow" >Agregar</button>
                    <button class="col btn btn-warning m-1 font-weight-bolder shadow">Limpiar informacion</button>
                    <button class="col btn btn-danger m-1 font-weight-bolder shadow">Cancelar</button>
                </div>
            </form>
        </div>
    </div>
